...
class FormationCardd extends StatelessWidget {
  final Function()? onClick;
  final Formation formation;
  const FormationCardd({
    super.key,
...
class FormationCategoryCard extends StatelessWidget {
  final String categoryName;
  const FormationCategoryCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Consumer<NavigationController>(
      builder: (context, navigationController, child) {
        return InkWell(
          onTap: () {
            // navigationController.navigateTo(const MyFormationScreen(), index: 1);
          },
          child: Container(
            margin: const EdgeInsets.symmetric(
              vertical: 5,
...
//                 const Row(
//                   children: [
//                     Text("Le schema de la communication"),
//                     Text("400DH"),
//                   ],
//                 ),
//                 const Row(
//                   children: [
//                     Text("La duree: 4 Mois"),
//                     Text("Etudiant: 73"),
//                     Text("Avis: 42"),
//                   ],
//                 ),
//                 const Text("Type de certificat que vous shouhaitez:")
