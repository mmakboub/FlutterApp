...
import 'package:library_app/screens/formations_out/register/formation_register.dart';
...
class FormationScreenOut extends StatefulWidget {
  final Formation formation;

  const FormationScreenOut({super.key, required this.formation});

  @override
  State<FormationScreenOut> createState() => _FormationScreenOutState();
}

class _FormationScreenOutState extends State<FormationScreenOut> {
                      ...
                      child: LibraryTextButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => FormationRegisterScreenOut(
